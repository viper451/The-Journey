...
function Team(props) {
    ...
    <h2>Without bonding and coordination,every project is a failure. Look at who makes KICKSUP great. ;{")"}</h2>
</div>
            <div className='row'>
  ...
  <div style={{margin: "24 px 0"}}>
    ...
    <img src={facebook} width={30} height={24} alt="" style={{padding:"3px",paddingBottom:"5px"}} /> 
    <img src={insta} width={30} height={24}  alt="" style={{padding:"3px", paddingBottom:"5px"}} /> 
  </div>
...
<div className="card">
  ...
  <div style={{margin: "24 px 0"}}>
  <img src={medium} width={30} height={24}  alt="" style={{padding:"3px"}} /> 
    <img src={nba} width={30} height={24}  alt="" style={{padding:"3px"}} />
    <img src={twitter} width={30} height={24} alt="" style={{padding:"3px"}} />  
  </div>
...
<div className="card">
  ...
  <div style={{margin: "24 px 0"}}>
  <img src={linkedin}  width={30} height={24}  alt="" style={{padding:"3px"}} /> 
  <img src={medium} width={30} height={24}  alt="" style={{padding:"3px"}} />
  <img src={facebook} width={30} height={24} alt="" style={{padding:"3px"}} />  
